...
export default function ModelCard({ model }) {
  return (
    <Link to={`/profile/${model.id}`}>
      <div className="bg-white rounded-xl shadow-lg p-4 hover:scale-105 transform transition">
        <img src={model.images[0]} alt={model.name} className="rounded-xl w-full h-48 object-cover" />
